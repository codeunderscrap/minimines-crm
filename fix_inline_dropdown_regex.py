...
pattern = re.compile(
    r'<div>\s*\{mgrName && \(\s*<div style=\{\{ fontSize: \'12px\' \}\}>\s*<span style=\{\{ color: BRAND\.text \}\}>Mgr: </span>\s*<span style=\{\{ fontWeight: 600, color: BRAND\.blue \}\}>\{mgrName\}</span>\s*</div>\s*\)\}\s*\{assocName && \(\s*<div style=\{\{ fontSize: \'12px\' \}\}>\s*<span style=\{\{ color: BRAND\.text \}\}>Assoc: </span>\s*<span style=\{\{ fontWeight: 600, color: BRAND\.green \}\}>\{assocName\}</span>\s*</div>\s*\)\}\s*</div>',
    re.DOTALL
)
